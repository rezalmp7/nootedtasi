                    <?php $page = 'form_roda_4'; include("layout/header.php"); ?> 
                    <div class="col-12 mt-5 pt-2">
                        <div class="card text-left checkout-area pt-100 pb-70">
                            <div class="card-body">
                                <h3 class="text-center">Form Kendaraan Roda 4</h3>
                                <div class="col-lg-8 mx-auto">
                                    <form method="POST" action="function/tambah_form_kendaraan_roda_2.php">
                                        <div class="checkout-billing">
                                            ...
                                            <div class="form-group">
                                                <?php
                                                $kendaraan = mysqli_query($conn, "SELECT * FROM kendaraan WHERE jenis='roda_4'");
                                                ?>
